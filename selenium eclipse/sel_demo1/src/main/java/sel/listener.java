...
public class listener implements WebDriverEventListener {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		sDriver.register(listener);
		sDriver.manage().window().maximize();
		sDriver.get("http://google.com");
		Thread.sleep(3000);
		WebElement search= sDriver.findElement(By.name("q"));
		search.sendKeys("amazon");
		search.sendKeys(Keys.ENTER);
		Thread.sleep(3000);;
		WebElement amazon= sDriver.findElement(By.xpath("//h3[text()='Amazon.com. Spend less. Smile more.']"));
		amazon.click();
		Thread.sleep(3000);
		sDriver.unregister(listener);
		sDriver.quit();
		driver.quit();
